...
PS_MULTIPLE_RENDER_TARGETS_OUTPUT PSMultiTexStaticModel(VS_MULTI_TEXTURED_LIGHTING_OUTPUT input, uint nPrimitiveID : SV_PrimitiveID)
{
...
PS_MULTIPLE_RENDER_TARGETS_OUTPUT PSMultiTexStaticInstanceModel(VS_MULTI_TEXTURED_LIGHTING_OUTPUT_INSTANCE input, uint nPrimitiveID : SV_PrimitiveID)
{
	PS_MULTIPLE_RENDER_TARGETS_OUTPUT output;
...
PS_MULTIPLE_RENDER_TARGETS_OUTPUT PSMultiTexDynamicModel(VS_MULTI_TEXTURED_LIGHTING_OUTPUT input, uint nPrimitiveID : SV_PrimitiveID)
{
	PS_MULTIPLE_RENDER_TARGETS_OUTPUT output;
...
PS_MULTIPLE_RENDER_TARGETS_OUTPUT PSMultiTexDynamicInstanceModel(VS_MULTI_TEXTURED_LIGHTING_OUTPUT_INSTANCE input, uint nPrimitiveID : SV_PrimitiveID)
{
	PS_MULTIPLE_RENDER_TARGETS_OUTPUT output;
...
PS_MULTIPLE_RENDER_TARGETS_OUTPUT PSNormalMap(VS_MODEL_MULTI_NORMAL_OUTPUT input)
{
